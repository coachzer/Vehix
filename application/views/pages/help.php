...
<div class="row text-center mb-3 d-flex align-items-center justify-content-center">
    <div class="col-6">
        <ul class="list-group">
            <li class="list-group-item">All the important links are featured in the navbar.</li>
            <li class="list-group-item">We advise you to register an account and log in to be able to make your own topic or start a category.</li>
